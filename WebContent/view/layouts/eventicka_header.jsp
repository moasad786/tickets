<header id="qcHomeHeader" style="position: relative;">
	<div class="row">
		...
		<div id="qcLogo" class="col-6 col">
			<a href="eventicka"><img src="${pageContext.request.contextPath}/view/eventicka/includes/img/placeholder/logo-header.png" alt="" /></a>
		</div>

		<nav id="qcPriNav" class="col-6 col">
			<ul class="clearfix">
				<li><a href="eventicka_event"><i class="icon-calendar-2 icon"></i> <span>Event Details</span></a></li>
				<li><a href="eventicka_ticket"><i class="icon-ticket icon"></i> <span>Buy Tickets</span></a></li>
			</ul>
		</nav>
