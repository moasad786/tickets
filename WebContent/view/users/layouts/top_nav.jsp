...
<header id="topnav" class="navbar navbar-default navbar-fixed-top" role="banner">
	...
	<div class="logo-area">
		<a class="navbar-brand navbar-brand-primary" href="${pageContext.request.contextPath}/users/myProfile">
			<%-- <img class="show-on-collapse img-logo-white" alt="Paper" src="${pageContext.request.contextPath}/view/users/assets/img/logo-icon-white.png">
			<img class="show-on-collapse img-logo-dark" alt="Paper" src="${pageContext.request.contextPath}/view/users/assets/img/logo-icon-dark.png">
			<img class="img-white" alt="Paper" src="${pageContext.request.contextPath}/view/users/assets/img/logo-white.png">
			<img class="img-dark" alt="Paper" src="${pageContext.request.contextPath}/view/users/assets/img/logo-dark.png"> --%>
			 
		<h3 style="color: #fff;font-size: 20px;text-transform: uppercase;text-align: center;">${sessionScope.user_role}</h3>
		</a> 
				...
				<div class="scroll-pane">
					<ul class="media-list scroll-content">
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="${pageContext.request.contextPath}/view/users/assets/demo/avatar/avatar_01.png" alt="" />
								</div>
								<div class="media-body">
						...
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="${pageContext.request.contextPath}/view/users/assets/demo/avatar/avatar_09.png" alt="" />
								</div>
								<div class="media-body">
						...
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="${pageContext.request.contextPath}/view/users/assets/demo/avatar/avatar_02.png" alt="" />
								</div>
								<div class="media-body">
						...
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="${pageContext.request.contextPath}/view/users/assets/demo/avatar/avatar_03.png" alt="" />
								</div>
								<div class="media-body">
						...
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="${pageContext.request.contextPath}/view/users/assets/demo/avatar/avatar_04.png" alt="" />
								</div>
								<div class="media-body">
						...
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="${pageContext.request.contextPath}/view/users/assets/demo/avatar/avatar_05.png" alt="" />
								</div>
								<div class="media-body">
						...
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="${pageContext.request.contextPath}/view/users/assets/demo/avatar/avatar_06.png" alt="" />
								</div>
								<div class="media-body">
