  ...
  <div class="logmod__wrapper">
    ...
    <div class="logmod__container">
      <ul class="logmod__tabs">
        ...
        <li data-tabtar="lgm-2" <c:if test="${param.page=='login' || param.page==null}"> class="current" </c:if> ><a href="#">Login</a></li>
        <li data-tabtar="lgm-1"  <c:if test="${param.page=='signup'}"> class="current" </c:if>  ><a href="#">Sign Up</a></li>
      </ul>
      <div class="logmod__tab-wrapper">
      <div class='logmod__tab lgm-1 <c:if test="${param.page=='signup'}"> show </c:if>'>
        <div class="logmod__heading">
          <span class="logmod__heading-subtitle">Enter your personal details <strong>to create an acount</strong></span>
        </div>
        <div id="msg_signup"></div>
        <div class="logmod__form">
          <form accept-charset="utf-8" action="" class="simform" method="post" id="users_signup_action">
            <div class="sminputs">
             <div class="input string optional">
                <label class="string optional" for="user-name">Fist Name*</label>
                <input class="string optional validate[required]" maxlength="255" id="first_name" name="first_name" placeholder="Fist Name" type="text" size="50" />
              </div>
              <div class="input string optional">
                <label class="string optional" for="user-name">Last Name*</label>
                <input class="string optional validate[required]" maxlength="255" id="last_name" name="last_name" placeholder="Last Name" type="text" size="50" />
              </div>
            </div>
              <div class="sminputs">
             <div class="input string optional">
                <label class="string optional" for="user-name">Email*</label>
                <input class="string optional validate[required,,custom[email]]" maxlength="255" id="email_id" name="email_id" placeholder="Email" type="email" size="50" />
              </div>
              <div class="input string optional">
                <label class="string optional" for="user-name">	Phone No*</label>
                <input class="string optional validate[required,,custom[phone]]" maxlength="255" id="phone" name="phone" placeholder="Phone No" type="text" size="50" />
              </div>
            </div> 
            <div class="sminputs">
              <div class="input string optional">
                <label class="string optional" for="user-pw">Password *</label>
                <input class="string optional validate[required]" maxlength="255" id="password" name="password" placeholder="Password" type="password" size="50" />
              </div>
              <div class="input string optional">
                <label class="string optional" for="user-pw-repeat">Repeat password *</label>
                <input class="string optional validate[required,equals[password]]" maxlength="255" id="repeat_password"  name="repeat_password" placeholder="Repeat password" type="password" size="50" />
              </div>
            </div>
              <div class=" row" style="padding: 15px 30px;">  
                <div class="input string optional col-md-4">
            <input type="radio" name="role" value="users" checked="checked" class="validate[required]"> Users
              </div> 
              <div class="input string optional col-md-4">
             <input type="radio" name="role" value="members" class="validate[required]"> Members
              </div>
                   
                <div class="input string optional col-md-4">
             <input type="radio" name="role" value="managers" class="validate[required]"> Manager
              </div>
                 
            </div>
            <div class="simform__actions">
              <input class="sumbit" name="commit" type="button" value="Create Account" id="creatAccountBtn" />
      ...
      <div class="logmod__tab lgm-2 <c:if test="${param.page=='login' || param.page==null}"> show </c:if>">
        <div class="logmod__heading">
          <span class="logmod__heading-subtitle">Enter your email and password <strong>to sign in</strong></span>
        </div> 
        <c:if test="${param.login=='incorrect'}">
        <div class="alert alert-danger">
            
        <p>Incorrect Login! Please enter correct email or password.</p>
        </div> 
        </c:if>
        <div class="logmod__form">
          <form accept-charset="utf-8" action="${pageContext.request.contextPath}/users_login_action" method="post" class="simform">
            <div class="sminputs">
              <div class="input full">
                <label class="string optional" for="user-name">Email*</label>
                <input class="string optional" maxlength="255" id="user-email" name="email_id" placeholder="Email" type="email" size="50" />
              </div>
            </div>
            <div class="sminputs">
              <div class="input full">
...
$("#creatAccountBtn").click(function()
		{
	$("#users_signup_action").validationEngine();

	if($("#users_signup_action").validationEngine('validate'))
		{
		  
		$.post("${pageContext.request.contextPath}/users_signup_action", 
			    {
